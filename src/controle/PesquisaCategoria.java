...
/*
 * PesquisaCategoria.java
 *
 * Created on 19/01/2010, 09:35:05
 */
...
public class PesquisaCategoria extends javax.swing.JInternalFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Cat.CarregaDados(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()));
    ...
    private void CarregaCategoria(){
        ...
        SQL = "select codigo, UPPER(nome) as nome from t_tipo_categoria where nome like '%" + jtfPesquisa.getText().toUpperCase() + "%' and exclusao = 0 ";
