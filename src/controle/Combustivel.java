 ...
 * Combustivel.java
 *
 * Created on 19/01/2010, 09:51:11
 */
 ...
 * @author Jeferson
 */
public class Combustivel extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Cadastro de Combutivel");

        jlbMarca.setText("Combustível");
    ...
    private void jbtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtExcluirActionPerformed
        ...
        if(resposta == JOptionPane.YES_OPTION){
            ...
            String SQL = "update t_tipo_combustivel set exclusao = 1 where codigo = " + jtfCodigo.getText() + "";
    ...
    private void jbtPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtPesquisarActionPerformed
        ...
        PesquisaCombustivel A = new PesquisaCombustivel();
        A.setVisible(true);
    ...
    private void jbtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSalvarActionPerformed
        ...
        Conexao = new ConexaoAccess();
        Conexao.Conectar();
        Conexao.setSQL("select * from t_tipo_combustivel where codigo = " + jtfCodigo.getText() + " ");
        ResultSet RS = Conexao.Consultar();

        try {
            if(RS.next()){
                String SQL;
                SQL = "update t_tipo_combustivel set nome = '" + jtfNome.getText().toUpperCase() + "' where codigo = " + jtfCodigo.getText() + "";
                Conexao.setSQL(SQL);
                Conexao.Executar();
            } else {
                String SQL;
                SQL = "insert into t_tipo_combustivel (codigo, nome, exclusao) values (" + jtfCodigo.getText() + ", '" + jtfNome.getText().toUpperCase() + "', 0)";
                Conexao.setSQL(SQL);
                Conexao.Executar();
            }
    ...
    public void CarregaDados(int Codigo){
        ...
        SQL = "select codigo, nome from t_tipo_combustivel where codigo = " + Codigo + " and exclusao = 0 ";
