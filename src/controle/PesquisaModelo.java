 ...
 * PesquisaModelo.java
 *
 * Created on 14/12/2009, 14:43:19
 */
 ...
 * @author Jeferson
 */
public class PesquisaModelo extends javax.swing.JInternalFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Mod.CarregaDados(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()));
    ...
    public void SetModelo(Modelo Mode){
            this.Mod = Mode;
    }
    ...
    private void CarregaModelo(){
        ...
        SQL = "select codigo, UPPER(nome) as nome from t_modelo where nome like '%" + jtfPesquisa.getText().toUpperCase() + "%' and exclusao = 0 ";
