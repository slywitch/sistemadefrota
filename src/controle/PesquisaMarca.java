 ...
 * PesquisaMarca.java
 *
 * Created on 14/12/2009, 13:54:44
 */
 ...
 * @author Jeferson
 */
public class PesquisaMarca extends javax.swing.JInternalFrame {

    public ConexaoAccess Conexao;
    public Marca Mar;

    /** Creates new form PesquisaMarca */
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Mar.CarregaDados(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()));
    ...
    private void CarregaMarca(){
        ...
        SQL = "select codigo, UPPER(nome) as nome from t_marca where nome like '%" + jtfPesquisa.getText().toUpperCase() + "%' and exclusao = 0 ";
