 ...
 * @author Jeferson
 */
public class PesquisaManutencao extends javax.swing.JInternalFrame {

    private ConexaoAccess Conexao;
    private Manutencao Man;
    String Meleca;
    
    /**
     * Creates new form PesquisaManutencao
     */
    public PesquisaManutencao() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaManutencao().setVisible(true);
            }
        });
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Man.CarregaDados(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
    ...
    public void SetPequisaManutencao(Manutencao Manu){
        this.Man = Manu;
    }
