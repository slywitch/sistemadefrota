 ...
 * PesquisaEstado.java
 *
 * Created on 14/12/2009, 16:55:36
 */
 ...
 * @author Jeferson
 */
public class PesquisaEstado extends javax.swing.JInternalFrame {

    private ConexaoAccess Conexao;
    private Estado UF;

    /** Creates new form PesquisaEstado */
    public PesquisaEstado() {
        initComponents();
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jtfPesquisa, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 340, Short.MAX_VALUE))
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        UF.CarregaDados(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaEstado().setVisible(true);
            }
        });
    }
    ...
    private void CarregaEstado(){
        ...
        SQL = "select (coduf) as codigo, UPPER(uf) as nome from cidade_uf ";
        SQL = SQL + "where uf like '%" + jtfPesquisa.getText().toUpperCase() + "%' ";
