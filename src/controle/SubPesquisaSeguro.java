 ...
 * @author Jeferson
 */
public class SubPesquisaSeguro extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form SubPesquisaSeguro
     */
    public SubPesquisaSeguro() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SubPesquisaSeguro().setVisible(true);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Sub Pesquisa de Seguro");
    ...
    public void SetSubPequisaSeguro(Seguro Segu){
        this.Seg = Segu;
    }
