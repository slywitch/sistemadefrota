...
/*
 * PesquisaEspecie.java
 *
 * Created on 19/01/2010, 10:19:35
 */
 ...
 * @author Jeferson
 */
public class PesquisaEspecie extends javax.swing.JInternalFrame {

    private ConexaoAccess Conexao;
    private Especie Esp;

    /** Creates new form PesquisaEspecie */
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Esp.CarregaDados(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaEspecie().setVisible(true);
            }
        });
    }
    ...
    public void SetEspecie(Especie Espe){
            this.Esp = Espe;
    }
    ...
    private void CarregaEspecie(){
        ...
        SQL = "select codigo, UPPER(nome) as nome from t_tipo_especie where nome like '%" + jtfPesquisa.getText().toUpperCase() + "%' and exclusao = 0 ";
