...
public class SubPesquisaCidade extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Procura cidade motorista");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jtfPesquisa, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 308, Short.MAX_VALUE))
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (Meleca.equals("Motorista")){
            Cid.PuxaCidade(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()));
        }else if (Meleca.equals("Fornecedor")){
            CF.PuxaCidade(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()));
        }else if (Meleca.equals("Veiculo")){
            Vei.BuscaCidade(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()));
        }
    ...
    public void SetSubCidade(Motorista Cidd){
        this.Cid = Cidd;
    }

    public void SetSubPesquisaFornecedores(CadFornecedores CFor){
        this.CF = CFor;
    }

    public void SetSubPesquisaVeiculos(Veiculo Veic){
        this.Vei = Veic;
    }
    ...
    private void CarregaCidade(){
        ...
        SQL = "select (codcidade) as codigo, (cidade) as nome from cidade ";
        SQL = SQL + "where cidade like '%" + jtfPesquisa.getText() + "%'";
