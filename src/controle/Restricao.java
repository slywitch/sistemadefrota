 ...
 * Restricao.java
 *
 * Created on 19/01/2010, 10:26:39
 */
 ...
 * @author Jeferson
 */
public class Restricao extends javax.swing.JInternalFrame {

    private ConexaoAccess Conexao;

    /** Creates new form Restricao */
    public Restricao() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Cadastro de Restrição");

        jlbMarca.setText("Restrição");
    ...
    private void jbtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtExcluirActionPerformed
        ...
        if(resposta == JOptionPane.YES_OPTION){
            ...
            String SQL = "update t_tipo_restricao set exclusao = 1 where codigo = " + jtfCodigo.getText() + "";
    ...
    private void jbtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSalvarActionPerformed
        ...
        Conexao = new ConexaoAccess();
        Conexao.Conectar();
        Conexao.setSQL("select * from t_tipo_restricao where codigo = " + jtfCodigo.getText() + " ");
        ResultSet RS = Conexao.Consultar();

        try {
            if(RS.next()){
                String SQL;
                SQL = "update t_tipo_restricao set nome = '" + jtfNome.getText().toUpperCase() + "' where codigo = " + jtfCodigo.getText() + "";
                Conexao.setSQL(SQL);
                Conexao.Executar();
            } else {
                String SQL;
                SQL = "insert into t_tipo_restricao (codigo, nome, exclusao) values (" + jtfCodigo.getText() + ", '" + jtfNome.getText().toUpperCase() + "', 0)";
                Conexao.setSQL(SQL);
                Conexao.Executar();
            }
    ...
    public void CarregaDados(int Codigo){
        ...
        SQL = "select codigo, nome from t_tipo_restricao where codigo = " + Codigo + " and exclusao = 0 ";
